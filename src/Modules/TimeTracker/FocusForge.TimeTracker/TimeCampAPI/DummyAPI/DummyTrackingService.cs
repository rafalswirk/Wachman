...
namespace FocusForge.TimeTracker.TimeCampAPI.DummyAPI
{
    public class DummyTrackingService : ITimeTrackingService
    {
        ...
        public Task<List<Job>> GetDailyJobsAsync() => Task.FromResult(new List<Job>()
        {
            ...
            new Job{ Name = "Tea time", Description = "Green tea", Start = new DateTime(2021, 11, 1, 12, 3, 22), Stop = new DateTime(2021, 11, 1, 13, 3, 22), Duration = TimeSpan.FromSeconds(320), IsRunning = true}
        });
